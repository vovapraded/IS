...
function RoutesTable({
  ...
  const handleDeleteClick = async (route) => {
    ...
    try {
      ...
      setError("Не удалось проверить зависимости маршрута. Удаление маршрута заблокировано для безопасности.");
      // НЕ показываем диалог удаления при ошибке проверки зависимостей
